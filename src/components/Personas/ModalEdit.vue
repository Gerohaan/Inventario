      ...
      <q-card flat class="text-primary bg-white" style="width: 700px; max-width: 80vw;">
        ...
        <q-card-section class="q-pt-none">
          <q-form id="form" @submit.prevent="updatePersona(), closeModal()">
            ...
            <div class="row">
              <div
                class="col-xs-12 col-sm-12 col-md-6 col-lg-6 col-xl-6 q-pr-md"
              >
                <q-input
                  dense
                  filled
            ...
            <div class="row">
              <div
                class="col-xs-6 col-sm-6 col-md-6 col-lg-6 col-xl-6 q-pr-md q-pt-xs"
              >
            ...
            <div class="col-12 q-pr-md q-pt-xs">
